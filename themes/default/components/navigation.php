<?php 
	$userInfo = $GLOBALS['auth0']->getUser();
	
?>
<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark-green">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active">
				<a class="nav-link" href="/">Car Inventory</span></a>
			</li>
			<li class="nav-item active">
		...
		<form class="form-inline my-2 my-lg-0" action="/" method="GET">
			<input class="form-control mr-sm-2" name="searchTerm" type="search" placeholder="Car Search" aria-label="Search">
